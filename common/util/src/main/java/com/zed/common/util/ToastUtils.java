...
public final class ToastUtils {
    ...
    private static int yOffset =
            (int) (64 * Utils.getApplicationContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void setView(@LayoutRes int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) Utils.getApplicationContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
