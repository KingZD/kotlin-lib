...
public final class IntentUtils {
     ...
     * 获取安装App(支持6.0)的意图
     * <p>
     * 需要在AndroidMainfest 文件中声明provider
     *
     * @param file 文件
     * @return intent
     */
    public static Intent getInstallAppIntent(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(Utils.getApplicationContext(),
                    Utils.getApplicationContext().getPackageName() + ".fileprovider", file);
