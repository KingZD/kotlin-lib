...
public final class SizeUtils {
    ...
    public static int dpToPx(float dipValue) {
        DisplayMetrics metrics = Utils.getApplicationContext().getResources().getDisplayMetrics();
    ...
    public static float applyDimension(int unit, float value) {
        return applyDimension(unit, value, Utils.getApplicationContext().getResources().getDisplayMetrics());
    }
    ...
    public static int getTextWidth(String text, float size) {
        ...
        paint.setTextSize(SizeUtils.sp2px(size));
