...
public final class NetworkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) Utils.getApplicationContext()
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) Utils.getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager wifiManager =
                (WifiManager) Utils.getApplicationContext().getSystemService(Context.WIFI_SERVICE);
