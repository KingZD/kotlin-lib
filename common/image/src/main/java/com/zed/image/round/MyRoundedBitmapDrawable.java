 ...
 */
@RequiresApi(9)
public abstract class MyRoundedBitmapDrawable extends Drawable {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (mPaint.getShader() == null) {
            ...
            switch (mCornerType) {
                case LEFT_TOP:
                    canvas.drawRect(new RectF(0f, mCornerRadius, mDstRectF.width(), mDstRectF.height()), mPaint);
                    canvas.drawRect(new RectF(mCornerRadius, 0f, mDstRectF.width(), mDstRectF.height()), mPaint);
                    break;
                case LEFT_BOTTOM:
                    canvas.drawRect(new RectF(0f, 0f, mDstRectF.width(), mDstRectF.height() - mCornerRadius), mPaint);
                    canvas.drawRect(new RectF(mCornerRadius, 0f, mDstRectF.width(), mDstRectF.height()), mPaint);
                    break;
                case RIGHT_TOP:
                    canvas.drawRect(new RectF(0f, 0f, mDstRectF.width() - mCornerRadius, mDstRectF.height()), mPaint);
                    canvas.drawRect(new RectF(0f, mCornerRadius, mDstRectF.width(), mDstRectF.height()), mPaint);
                    break;
                case RIGHT_BOTTOM:
                    canvas.drawRect(new RectF(mCornerRadius, mCornerRadius, mDstRectF.width(), mDstRectF.height()), mPaint);
                    break;
                case LEFT:
                    canvas.drawRect(new RectF(mCornerRadius, 0f, mDstRectF.width(), mDstRectF.height()), mPaint);
                    break;
                ...
                case TOP:
                    canvas.drawRect(new RectF(0f, mCornerRadius, mDstRectF.width(), mDstRectF.height()), mPaint);
                    break;
                case RECTANGLE_LEFT_TOP:
                    canvas.drawRect(new RectF(0f, 0f, mDstRectF.width() - mCornerRadius, mDstRectF.height() - mCornerRadius), mPaint);
                    break;
                case RECTANGLE_LEFT_BOTTOM:
                    canvas.drawRect(new RectF(0f, mCornerRadius, mDstRectF.width() - mCornerRadius, mDstRectF.height()), mPaint);
                    break;
                case RECTANGLE_RIGHT_TOP:
                    canvas.drawRect(new RectF(mCornerRadius, 0f, mDstRectF.width(), mDstRectF.height() - mCornerRadius), mPaint);
                    break;
                case RECTANGLE_RIGHT_BOTTOM:
                    canvas.drawRect(new RectF(mCornerRadius, mCornerRadius, mDstRectF.width(), mDstRectF.height()), mPaint);
                    break;
                case ALL:
                    break;
    ...
    MyRoundedBitmapDrawable(Resources res, Bitmap bitmap, CornerType type) {
        if (res != null) {
